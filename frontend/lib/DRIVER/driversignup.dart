...
//
// void main() {
//   runApp( DriverSignup(title: '',));
// }
//
// class DriverSignup extends StatefulWidget {
//   const DriverSignup({super.key, required this.title});
//
//   final String title;
//   @override
...
//     }
//
//     final uri = Uri.parse('$url/driver_signip/');
...
class _DriverSignupState extends State<DriverSignup> {
  ...
  Future<void> _sendData() async {
    ...
    String licenseno = licencenocontroller.text.trim();
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildTextFormField(
                    ...
                    validator: (v) => v?.trim().isEmpty ?? true ? 'License number is required' : null,
                  ),
                  const SizedBox(height: 20),
